  ...
  return (
    <section id="about" className="py-32 bg-gray-900">
      <div className="container mx-auto flex flex-col lg:flex-row items-center gap-12 px-6">
        ...
        {/* Text Section */}
        <div className="flex-1 flex flex-col justify-center text-center lg:text-left lg:pl-12">
          ...
          <p className="text-gray-300 leading-relaxed mb-8">
            I am currently in my 6th semester at COMSATS University Lahore. I
            enjoy creating web applications using React, Node.js, Express, and
            MongoDB. I am also learning AI, Machine Learning, Deep Learning, and
            Neural Networks to build intelligent solutions. My goal is to
            combine web development and AI skills to create innovative,
